/*
 * config.h — PrimusV2 Clean Receiver Configuration
 * ==================================================
...
const OutputTypeDef OUTPUT_TYPE_TABLE[] = {
  ...
  /* OUTPUT_GRID        */ { "Grid 8x4",    32, 3, LAYOUT_GRID,   8, 4 },
};
...
#define DEVICE_SHORT_NAME  "PrimusV2"          // max 17 chars + null
#define DEVICE_LONG_NAME   "PrimusV2 LED Node"  // max 63 chars + null
